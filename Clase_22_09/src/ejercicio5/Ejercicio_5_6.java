...
public class Ejercicio_5_6 {
    ...
    public void ejercicio_5_6_1_if(){
        int num1,par_impar;
        num1 = EntradaUtils.leerNumero(Integer.class, "Ingrese un número: ");
        if(num1 % 2==0){
            par_impar = 1;
        }else{
            par_impar = 0;
    ...
    public void ejercicio_5_6_2_if(){
        ...
        num1 = EntradaUtils.leerNumero(Byte.class, "Ingrese un  primer número (byte): ");
        num2 = EntradaUtils.leerNumero(Byte.class, "Ingrese un segundo número (byte): ");
        if(num1>num2){
            menor = num1;
        }else{
            menor = num2;
